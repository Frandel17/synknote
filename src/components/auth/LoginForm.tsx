            ...
            <div className="hidden lg:flex flex-col justify-between bg-black p-12 relative overflow-hidden">
                ...
                <div className="relative z-10">
                    <div className="flex items-center gap-3 mb-12">
                        ...
                        <h1 className="text-white text-2xl font-semibold tracking-tight">SynkNote</h1>
                    </div>

                    <h2 className="text-5xl font-bold text-white mb-6 leading-tight">Secure your digital future</h2>

                    <p className="text-zinc-400 text-base leading-relaxed max-w-md font-light">
                        Advanced blockchain technology meets seamless user experience. Your gateway to decentralized finance.
                    </p>
                </div>
                ...
                <div className="w-full max-w-md space-y-8">
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="text-center">
                            <Link href="#" className="text-zinc-500 hover:text-zinc-400 text-xs font-medium">
                                Forgot password?
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="pt-6 border-t border-zinc-800/50">
                        <p className="text-xs text-zinc-600 text-center">Protected by military-grade encryption</p>
                    </div>
                </div>
            </div>
        </div>
